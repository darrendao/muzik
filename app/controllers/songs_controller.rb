class SongsController < ApplicationController
  ...
  def datatable
    respond_to do |format|
      format.json do
        render(:json => Song.for_data_table(self, %w(action title artist album duration), %w(title artist album duration)) do |song|
          ...
          [action_links, song.title, song.artist, song.album, song.duration]
        end)
      end
    end
  end
